...
class IngredientsRecyclerViewAdapter(var context: Context, var ingredientList:ArrayList<IngredientsModel>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val text = ingredientList[position].getWeightVolume() + " " + ingredientList[position].getMeasurementUnit()
